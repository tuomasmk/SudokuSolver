 ...
 * https://github.com/coderodde/SudokuSolver/blob/master/src/net/coderodde/sudoku/App.java
 */
public class App {
    ...
    private void createSolver() {
        this.solver = new DancingLinksSolver();
    }
    ...
    private void scanDigits() {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            while (cellsToScan > 0) {
                ...
                inputSudoku.setNumber(x++, y, cellValue);
    ...
    private void solve() {
        ...
        try {
            ...
            solver.setSudoku(inputSudoku.copy(inputSudoku));
            solver.solve();
            Sudoku solution = solver.getSudoku();
